...
class CartController extends Controller
{
        ...
        public function update(Request $request, $rowId)
    {
        ...
        if($data['stock']< $data['qty']){
            Session::flash('error', 'La quantité de stock n\'est pas disponible.');
            return response()->json(['error' => 'Cart Quantity Is Not Available']); 
        }
    ...
    public function destroyCoupon(){
        ...
        return redirect()->back()->with('success','Le coupon a bien été supprimé!');
    }
}
